...
public class boj_17144_미세먼지안녕 {
    ...
    private static int flowOfTop(int r, int c, Point airPurifier, int[][] home) {
        ...
        candidate = moveRight(c, point, candidate, home, c);
        candidate = moveUp(c, point, candidate, home, 1);
        candidate = moveLeft(c, point, candidate, home, 1);
    ...
    private static int flowOfBottom(int r, int c, Point airPurifier, int[][] home) {
        ...
        candidate = moveRight(c, point, candidate, home, c);
        candidate = moveDown(c, point, candidate, home, r);
        candidate = moveLeft(c, point, candidate, home, 1);
