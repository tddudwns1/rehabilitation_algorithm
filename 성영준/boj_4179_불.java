...
public class boj_4179_불 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(process(maze, fires, jihuns));
    }

    private static String process(char[][] maze, Queue<Point> fires, Queue<Point> jihuns) {
        int count = 0;
        while (true) {
            count++;
            spread(maze, fires);

            if (escape(maze, jihuns))
    ...
    private static boolean escape(char[][] maze, Queue<Point> jihuns) {
